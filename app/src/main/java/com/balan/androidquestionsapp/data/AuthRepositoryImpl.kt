...
class AuthRepositoryImpl(
    ...
    override fun signUp(login: String, password: String, secondPassword : String,email: String): Validation {
        val newUser = User(
            id = 0,
            name = login,
            password = password,
        ...
        val signUpResult = userValidator.validateSignUp(user = newUser, secondPassword = secondPassword)
