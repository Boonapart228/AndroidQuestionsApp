...
val middleQuestion = """[
  ...
  },
  {
    ...
    "answers": [
      {
        "title": "Dispatchers.Default є найкращим вибором для довгих завдань, пов'язаних із читанням і записом великої кількості даних.",
        "isTrue": true
      },
      {
        "title": "Dispatchers.Main може використовуватися для оновлення користувацького інтерфейсу, але не для довгих завдань.",
        "isTrue": true
      },
      {
  ...
  },
  {
    ...
    "answers": [
      {
        "title": "Якщо корутину скасовано, дочірні корутини також повинні бути скасовані.",
        "isTrue": true
      },
      {
        "title": "Батьківська область видимості може завершитися до того, як одна чи кілька її дочірніх областей завершиться.",
        "isTrue": true
      },
      {
